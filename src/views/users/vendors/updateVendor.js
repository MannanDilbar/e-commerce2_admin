...
const UpdateVendor = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('/api/v1/vendors/' + location.state.id,
                {
                    headers: {
                ...
                <CCol md={11} lg={9} xl={7}></CCol>
                    ...
                    <CCol md={1} lg={1} xl={1}>
                                <CForm className='mt-1 mb-2'>
                                    ...
                                    ><img src={logo?URL.createObjectURL(logo):BASE_Image_URL+logoURL} style={{
